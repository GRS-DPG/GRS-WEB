<template>
  ...
  <div class="card mt-10 mx-5">
    ...
    <div
      ...
      data-bs-target="#kt_kt_add_grievance"
      aria-expanded="true"
      aria-controls="kt_kt_add_grievance"
    >
      <!--begin::Card title-->
    ...
    <!--begin::Content-->
    <div id="kt_kt_add_grievance" class="collapse show" v-loading="load">
      <!--begin::Form-->
        <!--begin::Card body-->
        <div class="card-body border-top p-9">
          ...
          <!--end::Input group-->
           <div class="row m-0">
             <div class="col-lg-3"></div><label class="col-lg-8 col-form-label text-center fw-semobold fs-6 mb-1">{{ translate("or") }}</label>
           </div>
           <!--begin::Input group-->
          <div class="row mb-6">
          ...
          <div class="row mb-6">
            ...
            <!--begin::Col-->
            <div class="col-lg-8 fv-row px-0">
             <Field
                type="text"
                name="company"
                class="form-control form-control-sm"
          ...
          <div class="row mb-6">
            ...
            <!--begin::Col-->
            <div class="col-lg-8 fv-row h-100 px-0">
               <KTEditor />
             <!--begin::Editor-->
 ...
 components: {
  ...
  methods: {
    ...
    async formSubmit() {
      ...
      formData.set('files', this.inputFiles);
      formData.set('fileNameByUser', this.fileName);
      this.loading = true;
      await ApiService.post('grievance/save',formData)
      .then((response) => {
          this.loading = false;
        Swal.fire({
